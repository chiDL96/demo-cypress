...
describe("Topic 09 Exercise", () => {
  ...
  it('TC_03_Custom_Radio_Checkbox_p1', () => {
    ...
    cy.xpath("//span[text()='Checked']//preceding::input").click({force:true});
    
  });

  it('TC_04_Custom_Radio_Checkbox_p2', () => {
    cy.visit("https://docs.google.com/forms/d/e/1FAIpQLSfiypnd69zhuDkjKgqvpID9kwO29UCzeCVrGGtbNPZXQok0jA/viewform");
